...
trial { trial_duration = stimuli_length; picture cross; sound { wavefile s1_ang_ss_trimF; }; code = "s1_ang_ss_trimF"; port_code = 2; };
trial { trial_duration = 2300; picture emoticons; };

trial { trial_duration = stimuli_length; picture cross; sound { wavefile s1_fea_ss_trimF; }; code = "s1_fea_ss_trimF"; port_code = 2; };
trial { trial_duration = 2300; picture emoticons; };

trial { trial_duration = stimuli_length; picture cross; sound { wavefile s1_fea_sw_trimF; }; code = "s1_fea_sw_trimF"; port_code = 2; };
trial { trial_duration = 2300; picture emoticons; };
